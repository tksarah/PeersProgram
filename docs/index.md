...
* The program is open to anyone, candidates will be selected by tksarah.
* However, since we have confirmed that the requirements are fairly challenging for non‑technical participants, we ask that candidates have at least some basic experience with Linux.
...
* [Price reference](https://astar.subscan.io/tools/charts?type=price)
...
## Funding
The rewards will be distributed from the [wallet balance](https://astar.subscan.io/account/aWqzwHw6cSzgRu8iHKG6CMMz6WjuYus9e85rNsnHuHhy7t1) secured during the previous season. Depending on future operational needs, additional proposals may be considered if necessary.
